...
The REDMI Book guides link to the ArchWiki page for machine-specific Linux hardware notes:

https://wiki.archlinux.org/title/Xiaomi_RedmiBook_Pro_16_2025

No ArchWiki screenshots or substantial text are copied into this repository; the guide summarizes a few hardware-support facts and points readers to the source.

## Rufus

Rufus is linked as the Windows USB image writer:

https://rufus.ie/

This repository does not redistribute Rufus.
